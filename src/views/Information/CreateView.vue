                                    ...
                                    <v-col cols="12" class="px-4 text-center color-black" style="font-size: 12px">
                                        <v-row no-gutters class="py-2">
                                            ...
                                            <v-col cols="11" class="px-4" v-if="!isPQREndReservation">
                                                <span style="font-size: 10px; line-height: 1.5">Phone number is mandatory
                                                    for generating the
                                                    receipt</span>
                                            </v-col>
                                        </v-row>
                                        <v-row no-gutters class="py-2">
                                            ...
                                            <v-col cols="11" class="px-2">
                                                <v-text-field class="pt-0" v-model="licencePlate" hide-details="auto"
                                                    maxlength="8" :rules="[rules.alphaNumeric]" @keyup="uppercase"
                                                ...
                                                <v-row no-gutters class="py-2">
                                                    ...
                                                    <v-col cols="11" class="px-2">
                                                        <v-text-field v-model="computedDateFormatted"
                                                            @click="() => { openDatePicker = true }" hide-details="auto"
